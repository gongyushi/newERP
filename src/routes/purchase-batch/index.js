        ...
        render: (value, record) => (
          <div style={{display:'flex',justifyContent:'center',alignItems:'center'}}>
            <PermissionButton
              ...
              action='purchase-batch/detail-base'
              href={`#/purchase-batch/detail-base?id=${record.id}&purchase_id=${this.state.id}`}
            >
              详情
            </PermissionButton>
            <PermissionButton
