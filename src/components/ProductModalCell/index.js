...
export default class ProductModalCell extends PureComponent {
  render() {
    const categoryArr = [];
        ...
        <Row>
          ...
          <Col span={20} className={styles.txtDiv}>
            <Tooltip
              ...
              title={tips}
            >
              <div><a href={this.props.action} onClick={this.props.onTurn}>{this.props.product_no ? this.props.product_no : '--'}</a></div>
